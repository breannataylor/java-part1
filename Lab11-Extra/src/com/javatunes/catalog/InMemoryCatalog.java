...
public class InMemoryCatalog implements Catalog {
    ...
    /*
     * TASK: final all MusicItems where title is same as artist.
     * For example, Madonna's first album is simply titled "Madonna."
     * findSelfTitled()
     * findSelfTitledAlbums()
     */
    public Collection<MusicItem> findSelfTitled(){
        // creates a new list to populate with data entries.
        Collection<MusicItem> result = new ArrayList<>();
        for (MusicItem item : catalogData) {    //utilize a for loop to go through catalog and assign one catalog entry to variable ('item') at a time.
     ...
     */
    public MusicItem findCheapest(MusicCategory category) {
        return null;
    }
     ...
     * Just the titles! -- collection of string
     */
