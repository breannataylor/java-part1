...
import com.hr.personnel.ExecutiveEmployee;
...
class HRClient {
    ...
    public static void main(String[] args) {
        ...
        dept.addEmployee(new HourlyEmployee("Julie", LocalDate.of(2000, 2, 2), 25.00, 30.00));
        ...
        dept.addEmployee(new ExecutiveEmployee("Killua", LocalDate.of(2023, 5, 9), 100_000.00));
