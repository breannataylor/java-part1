...
import java.time.DayOfWeek.*; //not it is MONDAY instead of DayofWeek.MONDAY
...
class DerivedDateTimeTest {
    ...
    public static void testEarlyRetirement() {
        // TODO
        LocalDate bday = LocalDate.of(1993,1,29);
    ...
    public static void testLaborDay() {
        // TODO
        //temporal adjusters is an all static class that return temporal adjuster objects
        LocalDate sept1 = LocalDate.of(1993,9,01);
    ...
    public static void testAnniversary() {
        ...
        LocalDate saturday = wedding.with(TemporalAdjusters.nextOrSame(DayOfWeek.SATURDAY));
        System.out.println(saturday);
        System.out.println(saturday.getDayOfWeek());
